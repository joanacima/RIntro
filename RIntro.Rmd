...
#What is a library? A library refers to a bundle of code, which includes various functions and datasets, that enables you to perform specific tasks that are not included in the base R functions.
